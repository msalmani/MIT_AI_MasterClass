...
This tutorial builds models to predict churn using different methodologies - random forests (RF), and artifitial neural networks (ANN). A comparative assessment of the models performance is shown, based on their respective confusion matrix and ROC curves. 
